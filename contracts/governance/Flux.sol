...
contract FLUXPolygon is ERC20 {
    address private constant PLOY_LOCKED_PROXY = 0x28FF66a1B95d7CAcf8eDED2e658f768F44841212;
...
contract aFlux is ERC20 {
    constructor() public ERC20("Flux Protocol", "aFLUX") {
        // total suplly = 2100 万
        _mint(msg.sender, 21000000 * 1e18);
    }
}
